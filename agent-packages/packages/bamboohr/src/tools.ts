...
export function createBambooHRToolsExport(config: BambooHRConfig): ToolConfig {
  ...
  const tools: QuixTool[] = [
    ...
    {
      tool: tool(async (args: GetEmployeeParams) => service.getEmployee(args), {
    ...
    {
      tool: tool(async (args: GetTimeOffBalanceParams) => service.getEmployeeTimeOffBalance(args), {
    ...
    {
      tool: tool(async (args: GetTimeOffRequestsParams) => service.getTimeOffRequests(args), {
    ...
    {
      tool: tool(async () => service.getTimeOffTypes(), {
    ...
    {
      tool: tool(async (args: CreateTimeOffRequestParams) => service.createTimeOffRequest(args), {
