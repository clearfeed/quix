...
import { QuixTool, ToolConfig } from '@clearfeed-ai/quix-common-agent';
...
export class QuixAgent {
  ...
  public async processWithTools(
    ...
    const availableTools: (QuixTool | DynamicStructuredTool)[] = availableFunctions.flatMap(
      (func) => func.availableTools
    );
